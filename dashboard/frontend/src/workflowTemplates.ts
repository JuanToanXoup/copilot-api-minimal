...
export const workflowTemplates: WorkflowTemplate[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { label: 'Draft', status: 'idle', agent: null, role: 'coder', outputType: 'code', outputSchema: '{"language": "typescript"}' },
      },
      {
        id: 'agent-2',
        type: 'agent',
        position: { x: 600, y: 100 },
        data: { label: 'Refine', status: 'idle', agent: null, role: 'reviewer', outputType: 'code', outputSchema: '{"hasComments": true}' },
      },
      {
        id: 'agent-3',
        type: 'agent',
        position: { x: 850, y: 100 },
        data: { label: 'Polish', status: 'idle', agent: null, role: 'docs', outputType: 'markdown' },
      },
      {
        id: 'output-1',
        type: 'output',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: 'agent',
        position: { x: 350, y: 50 },
        data: { label: 'Analysis', status: 'idle', agent: null, role: 'architect', outputType: 'json', outputSchema: '{"type":"object","required":["analysis","recommendations"]}' },
      },
      {
        id: 'agent-2',
        type: 'agent',
        position: { x: 350, y: 200 },
        data: { label: 'Implementation', status: 'idle', agent: null, role: 'coder', outputType: 'code', outputSchema: '{"language":"typescript"}' },
      },
      {
        id: 'agent-3',
        type: 'agent',
        position: { x: 350, y: 350 },
        data: { label: 'Testing', status: 'idle', agent: null, role: 'tester', outputType: 'code', outputSchema: '{"language":"typescript","hasTests":true}' },
      },
      {
        id: 'aggregator-1',
        type: 'aggregator',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: 'agent',
        position: { x: 550, y: 50 },
        data: { label: 'Coder', status: 'idle', agent: null, role: 'coder', outputType: 'code', outputSchema: '{"hasComments":true}' },
      },
      {
        id: 'agent-debug',
        type: 'agent',
        position: { x: 550, y: 200 },
        data: { label: 'Debugger', status: 'idle', agent: null, role: 'debugger', outputType: 'json', outputSchema: '{"type":"object","required":["issue","fix"]}' },
      },
      {
        id: 'agent-explain',
        type: 'agent',
        position: { x: 550, y: 350 },
        data: { label: 'Explainer', status: 'idle', agent: null, role: 'docs', outputType: 'markdown', outputSchema: '{"hasHeaders":true}' },
      },
      {
        id: 'output-1',
        type: 'output',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: 'agent',
        position: { x: 350, y: 50 },
        data: { label: 'Worker 1', status: 'idle', agent: null, role: 'coder', outputType: 'json', outputSchema: '{"type":"object","required":["task","result"]}' },
      },
      {
        id: 'agent-2',
        type: 'agent',
        position: { x: 350, y: 200 },
        data: { label: 'Worker 2', status: 'idle', agent: null, role: 'coder', outputType: 'json', outputSchema: '{"type":"object","required":["task","result"]}' },
      },
      {
        id: 'agent-3',
        type: 'agent',
        position: { x: 350, y: 350 },
        data: { label: 'Worker 3', status: 'idle', agent: null, role: 'coder', outputType: 'json', outputSchema: '{"type":"object","required":["task","result"]}' },
      },
      {
        id: 'synthesizer-1',
        type: 'agent',
        position: { x: 650, y: 200 },
        data: { label: 'Synthesizer', status: 'idle', agent: null, role: 'architect', outputType: 'markdown', outputSchema: '{"hasHeaders":true}' },
      },
      {
        id: 'output-1',
        type: 'output',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: 'agent',
        position: { x: 350, y: 200 },
        data: { label: 'Generator', status: 'idle', agent: null, role: 'coder', outputType: 'code', outputSchema: '{"language":"typescript","hasTests":true}' },
      },
      {
        id: 'evaluator-1',
        type: 'evaluator',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { label: 'Autonomous', status: 'idle', agent: null, role: 'coder', outputType: 'json', outputSchema: '{"type":"object","required":["status","result"]}' },
      },
      {
        id: 'output-1',
        type: 'output',
